...
export const getTasks = async (req, res, next) => {
    try {
        ...
        const tasks = await Task.find({ projectId }).populate("assignedTo", "name email role");
...
export const updateTask = async (req, res, next) => {
    try {
        ...
        const updatedTask = await Task.findByIdAndUpdate(taskId, { status, assignedTo }, { new: true }).populate("assignedTo", "name email role");
        if (!updatedTask) {
